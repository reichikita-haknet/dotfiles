...
SoloPrincipal() {
	...
	sed -i "s/bspc monitor $sec -d I II III IV V VI VII VIII IX X/bspc monitor -d I II III IV V VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
        # Reemplazo si existen los otros dos
	sed -i "s/bspc monitor $pri -o I II III IV V;bspc monitor $sec -o VI VII VIII IX X/bspc monitor -o I II III IV V VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
	sed -i "s/bspc monitor $sec -o I II III IV V VI VII VIII IX X/bspc monitor -o I II III IV V VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
	bspc monitor $sec -r
...
SoloSecundaria() {
	...
	# Reemplazo si existen los otros dos
        sed -i "s/bspc monitor $pri -o I II III IV V;bspc monitor $sec -o VI VII VIII IX X/bspc monitor $sec -o I II III IV V VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
        sed -i "s/bspc monitor -o I II III IV V VI VII VIII IX X/bspc monitor $sec -o I II III IV V VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
        bspc monitor $pri -r
...
Dividida() {
	...
	# Reemplazo si existen los otros dos
        sed -i "s/bspc monitor -o I II III IV V VI VII VIII IX X/bspc monitor $pri -o I II III IV V;bspc monitor $sec -o VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
        sed -i "s/bspc monitor $sec -o I II III IV V VI VII VIII IX X/bspc monitor $pri -o I II III IV V;bspc monitor $sec -o VI VII VIII IX X/g" ~/.config/bspwm/bspwmrc
